...
<head>
  ...
  <title>{{ trans('dashboard.admin_panel') }}</title>
  ...
  <!-- Date Picker -->
  <link rel="stylesheet" href="{{ url('/') }}/dashboard/bower_components/bootstrap-datepicker/dist/css/bootstrap-datepicker.min.css">
  <!-- Daterange picker -->
